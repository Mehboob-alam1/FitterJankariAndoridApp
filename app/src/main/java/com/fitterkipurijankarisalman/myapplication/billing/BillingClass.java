package com.fitterkipurijankarisalman.myapplication.billing;
...
public class BillingClass implements PurchasesUpdatedListener, BillingClientStateListener {
    ...
    public BillingClass(Activity activity) {
        ...
        skuListSubscriptionsList.add(Config.one_month_subscription_id);
        skuListSubscriptionsList.add(Config.six_month_subscription_id);
        skuListSubscriptionsList.add(Config.one_year_subscription_id);
    }
    ...
    public void isSubscribedToSubscriptionItem() {
        if (skuListSubscriptionsList != null) {
            billingClient.queryPurchasesAsync(
                    ...
                    new PurchasesResponseListener() {
                        ...
                        public void onQueryPurchasesResponse(@NonNull BillingResult billingResult, @NonNull List<Purchase> list) {
                            if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK) {
                                subscriptionStatus = list.size() > 0;
                                mCallback.getItemSubscriptionStatus(subscriptionStatus);
                            } else {
            ...
            Log.w("asxz", "initBilling: list null");
            mCallback.getItemSubscriptionStatus(subscriptionStatus);
        }
    }
    ...
    public interface BillingErrorHandler {
        ...
        void getItemSubscriptionStatus(Boolean status);
    }
