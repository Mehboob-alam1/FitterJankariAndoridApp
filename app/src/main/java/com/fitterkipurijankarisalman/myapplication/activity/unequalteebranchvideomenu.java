...
import com.fitterkipurijankarisalman.myapplication.databinding.ActivityUnequalteebranchvideomenuBinding;
...
public class unequalteebranchvideomenu extends AppCompatActivity implements View.OnClickListener {

    private ActivityUnequalteebranchvideomenuBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityUnequalteebranchvideomenuBinding.inflate(getLayoutInflater());
...
//
    ...
    private void startRequiredActivity() {
        if (flag == 1) {
            Intent unequalteebranchvideo1 = new Intent(this, unequalteebranchvideo1.class);
            startActivity(unequalteebranchvideo1);
        } else if (flag == 2) {
            Intent unequalteebranchvideo2 = new Intent(this, unequalteebranchvideo2.class);
            startActivity(unequalteebranchvideo2);
    ...
    private void loadRewardedAd(String rewardedId) {
        ...
        RewardedAd.load(this, rewardedId,
                ...
                //        Toast.makeText(unequalteebranchvideomenu.this, "Rewarded Ad failed to load.", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                        ...
                        if (mRewardedAd != null) {
                            Activity activityContext = unequalteebranchvideomenu.this;
                            mRewardedAd.show(activityContext, new OnUserEarnedRewardListener() {
                                @Override
                                public void onUserEarnedReward(@NonNull RewardItem rewardItem) {
                //                    Toast.makeText(unequalteebranchvideomenu.this, "The user earned the reward.", Toast.LENGTH_SHORT).show();
                                }
                            });
                        } else {
                //            Toast.makeText(unequalteebranchvideomenu.this, "The rewarded ad wasn't ready yet.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button1:
                flag = 1;
                startLoadingRewardedAd(getResources().getString(R.string.admob_rewarded_id_unequalteebranch1));
                break;
            case R.id.button2:
                flag = 2;
                startLoadingRewardedAd(getResources().getString(R.string.admob_rewarded_id_unequalteebranch2));
                break;
