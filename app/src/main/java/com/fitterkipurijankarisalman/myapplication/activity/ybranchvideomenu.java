...
import com.fitterkipurijankarisalman.myapplication.databinding.ActivityYbranchvideomenuBinding;
...
public class ybranchvideomenu extends AppCompatActivity implements View.OnClickListener {

    private ActivityYbranchvideomenuBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityYbranchvideomenuBinding.inflate(getLayoutInflater());
    ...
    private void startRequiredActivity() {
        if (flag == 1) {
            Intent ybranchkaisebanayevideo1 = new Intent(this, ybranchkaisebanayevideo1.class);
            startActivity(ybranchkaisebanayevideo1);
        } else if (flag == 2) {
            Intent ybranchkaisebanayevideo2 = new Intent(this, ybranchkaisebanayevideo2.class);
            startActivity(ybranchkaisebanayevideo2);
        } else if (flag == 3) {
            Intent ybranchkaisebanayevideo3 = new Intent(this, ybranchkaisebanayevideo3.class);
            startActivity(ybranchkaisebanayevideo3);
        } else if (flag == 4) {
    ...
    private void loadRewardedAd(String rewardedId) {
        ...
        RewardedAd.load(this, rewardedId,
                adRequest, new RewardedAdLoadCallback() {
                    ...
                    //    Toast.makeText(ybranchvideomenu.this, "Rewarded Ad failed to load.", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                        ...
                        if (mRewardedAd != null) {
                            Activity activityContext = ybranchvideomenu.this;
                            mRewardedAd.show(activityContext, new OnUserEarnedRewardListener() {
                                @Override
                                public void onUserEarnedReward(@NonNull RewardItem rewardItem) {
                       //             Toast.makeText(ybranchvideomenu.this, "The user earned the reward.", Toast.LENGTH_SHORT).show();
                                }
                            });
                        } else {
                     //       Toast.makeText(ybranchvideomenu.this, "The rewarded ad wasn't ready yet.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button1:
                flag = 1;
                startLoadingRewardedAd(getResources().getString(R.string.admob_rewarded_id_ybranchkaisebanaye));
                break;
            case R.id.button2:
                flag = 2;
