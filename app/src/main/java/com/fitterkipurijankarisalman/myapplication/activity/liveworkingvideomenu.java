...
public class liveworkingvideomenu extends AppCompatActivity implements View.OnClickListener {

    private ActivityLiveworkingvideomenuBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLiveworkingvideomenuBinding.inflate(getLayoutInflater());
    ...
    private void startRequiredActivity() {
        if (flag == 1) {
            Intent aaiyesitedikhatehai = new Intent(this, aaiyesitedikhatehai.class);
            startActivity(aaiyesitedikhatehai);
        } else if (flag == 2) {
            Intent builtupkaisebanatehaivideo = new Intent(this, builtupkaisebanatehaivideo.class);
            startActivity(builtupkaisebanatehaivideo);
        } else if (flag == 3) {
        ...
        RewardedAd.load(this, rewardedId,
                adRequest, new RewardedAdLoadCallback() {
                    ...
                    public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                     ...
                     //   Toast.makeText(liveworkingvideomenu.this, "Rewarded Ad failed to load.", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                        ...
                        if (mRewardedAd != null) {
                            Activity activityContext = liveworkingvideomenu.this;
                            mRewardedAd.show(activityContext, new OnUserEarnedRewardListener() {
                                @Override
                                public void onUserEarnedReward(@NonNull RewardItem rewardItem) {
                //                    Toast.makeText(liveworkingvideomenu.this, "The user earned the reward.", Toast.LENGTH_SHORT).show();
                                }
                            });
                        } else {
                //            Toast.makeText(liveworkingvideomenu.this, "The rewarded ad wasn't ready yet.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
