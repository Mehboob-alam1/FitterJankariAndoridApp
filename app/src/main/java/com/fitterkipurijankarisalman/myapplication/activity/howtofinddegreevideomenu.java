...
import com.fitterkipurijankarisalman.myapplication.databinding.ActivityHowtofinddegreevideomenuBinding;
...
public class howtofinddegreevideomenu extends AppCompatActivity implements View.OnClickListener {

    private ActivityHowtofinddegreevideomenuBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHowtofinddegreevideomenuBinding.inflate(getLayoutInflater());
    ...
    private void startRequiredActivity() {
        if (flag == 1) {
            Intent howtofinddegreevideo1 = new Intent(this, howtofinddegreevideo1.class);
            startActivity(howtofinddegreevideo1);
        } else if (flag == 2) {
            Intent howtofinddegreevideo2 = new Intent(this, howtofinddegreevideo2.class);
            startActivity(howtofinddegreevideo2);
        ...
        RewardedAd.load(this, rewardedId,
                adRequest, new RewardedAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                        ...
                        if (mRewardedAd != null) {
                            Activity activityContext = howtofinddegreevideomenu.this;
