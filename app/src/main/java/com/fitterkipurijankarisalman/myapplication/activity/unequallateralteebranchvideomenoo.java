...
import com.fitterkipurijankarisalman.myapplication.databinding.ActivityUnequallateralteebranchvideomenooBinding;
...
public class unequallateralteebranchvideomenoo extends AppCompatActivity implements View.OnClickListener {

    private ActivityUnequallateralteebranchvideomenooBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityUnequallateralteebranchvideomenooBinding.inflate(getLayoutInflater());
        ...
        RewardedAd.load(this, rewardedId,
                adRequest, new RewardedAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                        ...
                        if (mRewardedAd != null) {
                            Activity activityContext = unequallateralteebranchvideomenoo.this;
