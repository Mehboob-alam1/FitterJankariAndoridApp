...
public class drawingshortcutt extends AppCompatActivity implements View.OnClickListener {

    private ActivityDrawingshortcuttBinding binding;
//    private Dialog loadingDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDrawingshortcuttBinding.inflate(getLayoutInflater());
      ...
      //                  loadingDialog.dismiss();
         ...
         //                       Toast.makeText(drawingshortcutt.this, "Ad failed to load full screen content", Toast.LENGTH_SHORT).show();
                        ...
                        if (mInterstitialAd != null) {
                            mInterstitialAd.show(drawingshortcutt.this);
                        }
                    }
        ...
        RewardedAd.load(this, rewardedId,
          ...
          //              loadingDialog.dismiss();
           ...
           //                     startRequiredActivity();
                        ...
                        if (mRewardedAd != null) {
                            Activity activityContext = drawingshortcutt.this;
                            mRewardedAd.show(activityContext, new OnUserEarnedRewardListener() {
                                @Override
                                public void onUserEarnedReward(@NonNull RewardItem rewardItem) {
                                    Toast.makeText(drawingshortcutt.this, "The user earned the reward.", Toast.LENGTH_SHORT).show();
                                }
                            });
                        } else {
                            Toast.makeText(drawingshortcutt.this, "The rewarded ad wasn't ready yet.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
